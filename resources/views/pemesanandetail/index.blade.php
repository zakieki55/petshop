        ...
        <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table table-hover">
                    ...
                    @foreach ($data_pemesanandetail as $pemesanandetail)
                    <tbody>
                        <tr>
                            <td>{{ $pemesanandetail->id }}</td>
                            <td>{{ $pemesanandetail->jumlah }}</td>
                            <td>{{ $pemesanandetail->subtotal }}</td>
                            <td><a href="/pemesanandetail/{{$pemesanandetail->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                            <a href="/pemesanandetail/delete/{{$pemesanandetail->id}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau hapus data?')">Delete</a></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('add.pmsanan') }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input name="subtotal" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="EmailHelp" placeholder="subtotal">
                        </div>
                </div>
